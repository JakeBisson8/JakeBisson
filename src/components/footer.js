    ...
    return (
        <footer className="bg-silver px-16 md:px-24 lg:px-48 xl:px-64 py-6 text-primary">
            <div class="flex flex-col sm:flex-row justify-between items-center flex-wrap">
                <div>
                    <button className="border border-primary rounded-xl text-primary px-3 py-2 hover:bg-primary hover:text-silver hover:shadow-lg duration-200">Resume</button>
                </div>
                <div className=" text-center m-5 sm:m-0">
                    <div className="text-3xl font-bold">Jake Bisson</div>
                    <div className="text-secondary">jlb4@rogers.com</div>
                </div>
                <div>
