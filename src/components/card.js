    ...
    return (
        <div className="card duration-150">
            ...
            <div className="p-5">
                ...
                <a href={params.repoUrl} rel="noreferrer" target="_blank" className="block text-center border p-2 border-primary rounded-md text-primary hover:bg-primary hover:text-silver hover:shadow-lg duration-200 md:inline-block">Repository</a>
            </div>
        </div>
    );
};
